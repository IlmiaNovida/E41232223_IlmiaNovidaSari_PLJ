...
<main id="main" class="main">
    <div class="pagetittle">
        ...
        <nav>
            <ol class="breadcrum">
                    <li class="breadcrum-item"><a href="{{ url('dashboard')}}">Home</a></li>
                    <li class="breadcrum-item">Riwayat Hidup</li>
                    <li class="breadcrum-item">Pendidikan</li>
</ol>
</nav>
</div>
<section class="section dashboard">
...
@endif
                            ...
                            Vertical Form -->
                            <!-- <form class="row g-3" action="{{ isset($pendidikan) ?
                            route('pendidikan.update', $pendidikan) : route('pendidikan.store') }}"
                            id="pendidikan_form" method="POST">
                                {!! csrf_field() !!}
                                {!! isset($pendidikan) ? method_field('PUT') : '' !!}
                                <div class="col-12">
